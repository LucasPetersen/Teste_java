...
public class ProdutoController {
    ...
    public ResponseEntity<List<Produto>> findAll() { return ResponseEntity.ok(service.findAll());
    }
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public void delete(@RequestParam(name = "id") String id) { service.delete(id);
    }
}
